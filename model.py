...
class DecoderOnlyModel(nn.Module):
    def __init__(self, num_layers, num_heads, embed_dim, context_length=500, dropout_rate=0.1, device='cpu', dtype=torch.float32, model_name="DecoderOnlyModel", with_encoder=False):
        super().__init__()
